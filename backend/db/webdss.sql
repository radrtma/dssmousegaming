...
(2, 'Logitech G502 HERO', 669000.00, 25600, 11, 'sangat_baik', 121.00),
(3, 'Razer Cobra Wired', 569000.00, 8500, 6, 'premium', 58.00),
(4, 'Razer DeathAdder V3 Wired', 1239000.00, 30000, 6, 'premium', 59.00),
(5, 'SteelSeries Rival 3 Gen 2 Wired', 730000.00, 8500, 6, 'sangat_baik', 77.00),
(6, 'HyperX Pulsefire Haste 2 Wired', 749000.00, 26000, 6, 'premium', 53.00),
(7, 'Corsair KATAR PRO XT', 648248.00, 18000, 6, 'baik', 73.00),
(8, 'Corsair SABRE RGB PRO Champion Series', 939000.00, 18000, 6, 'sangat_baik', 74.00),
(9, 'Cooler Master MM730', 513000.00, 16000, 6, 'premium', 48.00),
(10, 'Glorious Model O 2 Mini Wired', 889378.00, 26000, 6, 'premium', 49.00);
